<div class="about-header">
  <img src="assets/profile.jpeg" alt="Portrait of Jullien Thur" class="about-avatar" width="160" height="160" loading="lazy" />
  <div class="about-header-content">
    <h1 class="title">Hi, I'm Jullien!</h1>
    <div class="about-socials" style="display:flex;gap:1.25rem;align-items:center;flex-wrap:wrap;margin-top:0.5rem;">

  <a href="https://github.com/jullienthur" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:0.5rem;text-decoration:none;color:var(--color-accent-2);">
  ...
  <a href="https://www.linkedin.com/in/jullien-thur-5830b9270/" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:0.5rem;text-decoration:none;color:var(--color-accent-2);">
  ...
  <a href="mailto:jullien.s.thur@gmail.com" style="display:inline-flex;align-items:center;gap:0.5rem;text-decoration:none;color:var(--color-accent-2);">
...
&nbsp; 
I'm a second-year **Mechanical Engineering student at the University of Utah**, minoring in Computer Science with an emphasis on Robotics & Controls.

Ultimately, I want to explore the intersection of electrical and mechanical systems to design advanced medical robotics and surgical devices. 
